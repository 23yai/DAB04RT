...
def main():
    ...
    st.title("JobExplorer: buscador de Ofertas de Empleo Tecnológico")
    ...
    with st.sidebar:
        choice = st.radio(
            "Navegación",
            ("Bienvenidos", "SQL Chart","Ofertas de empleo", "Comparador", "Power BI", "Clustering", "Clasificación", "¿Quiénes somos?"),
            index=0
        )
